...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUser()).thenReturn("arturszuberla");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/arturszuberla/boards?key=test&token=test&fields=name,id&lists=all");
